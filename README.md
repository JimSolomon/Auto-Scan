...
This [bash auto recon scripts](https://github.com/JimSolomon/Auto-Scan/blob/main/auto-scan.sh)] will auto emuerate targets and its ssl, ports, user-agents, directories, sub-domains infomation. It combined tools
